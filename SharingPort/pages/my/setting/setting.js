...
Page({
  data: {
    ...
    pho_num: "15557565532",   	//骑手手机号——> 直接从User表获取
    nickname: "hym",   	//骑手昵称——> 直接从User表获取
    school_num: "2019",   	//学号——> 直接从User表获取
    img_src:"",    		//骑手头像——> 直接从User表获取
    user_num:"0",  	//当前用户数——> 默认0直接Post给服务器
    user_max:"",  	//单次最大拿单量——> 骑手输入
    user_max_weight:"",  	//单次最大拿单量——> 骑手输入
    user_max_size:"",  	//单次最大拿单量——> 骑手输入
    user_list:"",  		//骑手客户数(不上传)
    ava_time:"",   	//接单时间——> 骑手填写
    locationave:'', //可配送范围
    details:"",    		//骑手自白——> 骑手填写
  ...
  choosemaxweight:function(e){//选择可以接单的最大重量
    var user_max_weight = parseInt(e.detail.value)+1;
    this.setData({user_max_weight});
  },
  choosemaxsize:function(e){//选择可以接单的最大尺寸
    var user_max_size = parseInt(e.detail.value)+1;
    this.setData({user_max_size});
  },
